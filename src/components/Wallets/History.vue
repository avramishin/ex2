  ...
  <div>
    <div>
      <div class="card">
        ...
        <div class="button3">
          <div>
            <md-button class="md-dense md-primary button2" @click="openDeposit(currency)">Deposit</md-button>
          </div>
          <div>
            <md-button class="md-dense md-primary button2" @click="openWithdraw(currency)">Withdraw</md-button>
          </div>
          <div>
