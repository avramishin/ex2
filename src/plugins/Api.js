...
export default {
    ...
    const me = {
        ...
        usersLogin(params = {}) {
            return me._wrap(Vue.http.post(
                `${me.baseurl}/users/login`,
                me._fd(params))
            )
        },

        settingsList () {
            return me._wrap(Vue.http.get(
                `${me.baseurl}/settings/list`
            ))
        },
        ...
        exchangeWalletsList(params = {}) {
            utils.object.defaults(params, {session_id: me.sessionId});
            return me._wrap(Vue.http.post(
                `${me.baseurl}/exchange/wallets/list`,
                me._fd(params))
            )
        },
