...
export default {
  install(Vue, options) {
    const me = {
      ...
      usersLogin(params = {}) {
        return me._wrap(
          Vue.http.post(`${me.baseurl}/users/login`, me._fd(params))
        )
      },
      ...
      usersProfile(params = {}) {
        utils.object.defaults(params, {
          session_id: me.sessionId
        })
        return me._wrap(
          Vue.http.post(`${me.baseurl}/users/profile`, me._fd(params))
        )
      },
      ...
      exchangeWalletsList(params = {}) {
        ...
        return me._wrap(
          Vue.http.post(`${me.baseurl}/exchange/wallets/list`, me._fd(params))
        )
      },
