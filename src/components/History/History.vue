<template>
	<div>
		<div>
			<div class="card">
				<div class="balance">0,19 wmz</div>
				<div class="button3">
					<div>
						<md-button class="md-dense md-primary button2">Пополнить</md-button>
					</div>
					<div>
						<md-button class="md-dense md-primary button2">Вывести</md-button>
					</div>
					<div>
						<md-button class="md-dense md-primary button2">Обменять</md-button>
					</div> 
				</div>
			</div>
		</div>
